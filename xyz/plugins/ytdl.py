...
async def download_video(event):
  ...
  try:
    ...
    await vtx.edit("Feteching data , please wait...")
    ...
    await vtx.edit("`video is not available from your geographic location due to geographic restrictions imposed by a website`")

    return

  except MaxDownloadReached :
  ...
  if song:
    ...
    await vtx.edit(f"`preparing to upload song: `\
    ...
    await bot.send_file(
      ...
      progress_callback=lambda d,t :asyncio.get_event_loop().create_task(
        ...
        progress( d, t, vtx, c_time, "uploading...",f"{ytdl_data['title']}.mp3"
    ...
    await bot.send_file(
      ...
      progress_callback=lambda d, t: asyncio.get_event_loop().create_task(
        ...
        progress( d, t, event, c_time, "Uploading..", f"{ytdl_data['title']}.mp4")
